...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">Jumalah</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"peminjaman/peminjaman_bahan/show_editForm/","#divsubcontent")','Simpan','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
