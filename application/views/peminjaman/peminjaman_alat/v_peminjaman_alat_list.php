          ...
          <div class="box-header with-border">
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '2' || $sesi == '3' || $sesi == '6') {
                echo button('load_silent("peminjaman/peminjaman_alat/form/base","#modal")','Add New peminjaman','btn btn-success');
              } else {
                # code...
              }
              ?>
          ...
          <tr>
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '4' || $sesi == '5' || $sesi == '6'|| $sesi == '7'|| $sesi == '8') {
                echo button('load_silent("peminjaman/peminjaman_alat/form/sub/'.$row->id_peminjaman.'","#modal")','','btn btn-info fa fa-edit','data-toggle="tooltip" title="Edit"');
              } else {
                # code...
              }
